    ...
    function __construct(){
        ...
        $this->entries = array(
            1 => FormulaBase::create_func_entry(
                'Total Amps using Resistor Amps and Capacitor Amps',
                function($num, $num2){
            ...
            FormulaBase::create_func_entry(
                'Impedance using Resistance and Capacitive Reactance',
                function($num, $num2){
            ...
            FormulaBase::create_func_entry(
                'Resistor Amps using Total Amps and Capacitor Amps',
                function($num, $num2){
                    $result = pow($num, 2) - pow($num2, 2);
                    if ( $result <= 0 ){
                        return array($this->error_msg, '');
            ...
            FormulaBase::create_func_entry(
                'Resistor Amps using Watts and Impedance',
                function($num, $num2){
                    $result = sqrt($num / $num2);
                    return array($this->prec($result, 4), $this->pluralize($result, 'Resistor Amp'));
                },
            ...
            FormulaBase::create_func_entry(
                'Resistor Amps using Power Factor and Total Amps',
                function($num, $num2){
                    $result = $num * $num2;
                    return array($this->prec($result, 4), $this->pluralize($result, 'Resistor Amp'));
                },
            ...
            FormulaBase::create_func_entry(
                'Total Volts using Votl Amps and Impedance',
                function($num, $num2){
                    $result = sqrt($num * $num2);
                    return array($this->prec($result, 4), $this->pluralize($result, 'Total Volt'));
                },
            ...
            FormulaBase::create_func_entry(
                "Capacitor Volts using Capacitor VAR's and Capcitive Reacatance",
                function($num, $num2){
                    $result = sqrt($num * $num2);
                    return array($this->prec($result, 4), $this->pluralize($result, 'Capacitor Volt'));
                },
            ...
            FormulaBase::create_func_entry(
                'Capacitor Amps using Total Amps and Resistor Amps',
                function($num, $num2){
                    $result = pow($num,2) - pow($num2, 2);
                    if ( $result <= 0 ){
                        return array($this->error_msg, '');
