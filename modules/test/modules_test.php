...
--------------------------------\n";
	...
	/*
	$list = new ArrayObject($ged->function_list);
	$test = $list->offsetGet($ged->function_strings[15]);
	$inputs = strval(count($ged->functionInputs[$ged->function_strings[15]]));
	echo "\nInputs: $inputs\n";
	$test = var_dump($test(234, 234, 234));
	echo $test;
	 */
