...
$ris = $cats["Resistive Inductive Series"];

$test = new TestSuite();

function Resist_Induc_Ser_test($test, $class){
    ...
    if ( $class->function_list[$class->function_strings[4]](234,234) !== array($class->prec(pow(234,2) / 234, 4), "Impedance")){
    ...
    if ( $class->function_list[$class->function_strings[5]](234,234) !== array($class->prec(234/pow(234,2), 4), "Impedance")){
    ...
    if ( $class->function_list[$class->function_strings[6]](234,234) !== array($class->prec(sqrt(234/234), 4), "Inductor Amp")){
    ...
    if ( $class->function_list[$class->function_strings[7]](234,234) !== array($class->prec(234/234, 4), "Inductor Amp")){
    ...
    if ( $class->function_list[$class->function_strings[8]](234,234) !== array($class->prec(234/234, 4), "Inductor Amp")){
    ...
    if ( $class->function_list[$class->function_strings[9]](234,234) !== array($class->prec(234/(2*$class->PI*234), 4), "Inductor Size")){
    ...
    if ( $class->function_list[$class->function_strings[10]](234,234) !== array($class->prec(2*$class->PI*234*234, 4), "Inductive Reactance Rating")){
    ...
    if ( $class->function_list[$class->function_strings[11]](234,234) !== array($class->prec(234/pow(234,2),4), "Inductive Reactance Rating")){
    ...
    if ( $class->function_list[$class->function_strings[12]](234,23) !== array($class->prec(sqrt(pow(234,2)-pow(23,2)),4), "Inductive Reactance Rating")){
    ...
    if ( $class->function_list[$class->function_strings[12]](234,234) !== array($class->error_msg, "")){
        $test->set_fail($class->function_strings[12]);
        $fail++;
    } else {
        $test->set_pass($class->function_strings[12]);
    ...
    if ( $class->function_list[$class->function_strings[13]](234,234) !== array($class->prec(234/234,4), "Inductive Reactance Rating")){
    ...
    if ( $class->function_list[$class->function_strings[14]](234,234) !== array($class->prec(pow(234,2)/234, 4), "Inductive Reactance Rating")){
    ...
    if ( $class->function_list[$class->function_strings[15]](234,234) !== array($class->prec(pow(234,2)*234,4), "Inductor VARs")){
    ...
    if ( $class->function_list[$class->function_strings[16]](234,234) !== array($class->prec(234*234, 4), "Inductor VARs")){
    ...
    if ( $class->function_list[$class->function_strings[17]](234,234) !== array($class->prec(pow(234,2)/234,4), "Inductor VARs")){
    ...
    if ( $class->function_list[$class->function_strings[18]](234,23) !== array($class->prec(sqrt(pow(234,2)-pow(23,2)),4), "Inductor VARs")){
    ...
    if ( $class->function_list[$class->function_strings[18]](234,234) !== array($class->error_msg, "")){
        $test->set_fail($class->function_strings[18]);
        $fail++;
    } else {
        $test->set_pass($class->function_strings[18]);
    ...
    if ( $class->function_list[$class->function_strings[19]](234,234) !== array($class->prec(234*234,4), "Inductor Volts")){
    ...
    if ( $class->function_list[$class->function_strings[21]](234,234) !== array($class->prec(234/234,4), "Inductor Volt")){
    ...
    if ( $class->function_list[$class->function_strings[22]](234,234) !== array($class->error_msg, "")){
    ...
    if ( $class->function_list[$class->function_strings[22]](234,23) !== array($class->prec(sqrt(pow(234,2)-pow(23,2)),4), "Inductor Volts")){
        $test->set_fail($class->function_strings[22]);
        $fail++;
    } else {
        $test->set_pass($class->function_strings[22]);
    ...
    if ( $class->function_list[$class->function_strings[27]](234,234) !== array($class->error_msg, "")){
    ...
    if ( $class->function_list[$class->function_strings[27]](234,23) !== array($class->prec(sqrt(pow(234,2)-pow(23,2)),4), "Resistance")){
        $test->set_fail($class->function_strings[27]);
        $fail++;
    } else {
        $test->set_pass($class->function_strings[27]);
    ...
    if ( $class->function_list[$class->function_strings[30]](234,234) !== array($class->prec(pow(234,2)*234,4), "Resistance")){
    ...
    if ( $class->function_list[$class->function_strings[31]](234,234) !== array($class->prec(234/pow(234,2),4), "Resistance")){
    ...
    if ( $class->function_list[$class->function_strings[36]](234,234) !== array($class->error_msg, "")){
    ...
    if ( $class->function_list[$class->function_strings[36]](234,23) !== array($class->prec(sqrt(pow(234,2)-pow(23,2)),4), "Resistor Volts")){
        $test->set_fail($class->function_strings[36]);
        $fail++;
    } else {
        $test->set_pass($class->function_strings[36]);
    ...
    if ( $class->function_list[$class->function_strings[37]](234,234) !== array($class->prec(234*234,4), "Resistor Volts")){
    ...
    if ( $class->function_list[$class->function_strings[38]](234,234) !== array($class->prec(sqrt(234*234),4), "Resistor Volts")){
    ...
    if ( $class->function_list[$class->function_strings[39]](234,234) !== array($class->prec(234/234,4), "Resistor Volt")){
    ...
    if ( $class->function_list[$class->function_strings[42]](234,234) !== array($class->prec(sqrt(pow(234,2)+pow(234,2)),4), "Total Volts")){
    ...
    if ( $class->function_list[$class->function_strings[45]](234,234) !== array($class->prec(234/234,4), "Total Volt")){
    ...
    if ( $class->function_list[$class->function_strings[47]](234,234) !== array($class->prec(234*234,4), "Volt Amps")){
    ...
    if ( $class->function_list[$class->function_strings[49]](234,234) !== array($class->prec(sqrt(pow(234,2)+pow(234,2)),4), "Volt Amps")){
    ...
    if ( $class->function_list[$class->function_strings[50]](234,234) !== array($class->prec(234/234,4), "Volt Amp")){
    ...
    if ( $class->function_list[$class->function_strings[51]](234,234) !== array($class->prec(pow(234,2)*234,4), "Watts")){
    ...
    if ( $class->function_list[$class->function_strings[52]](234,234) !== array($class->prec(234*234,4), "Watts")){
    ...
    if ( $class->function_list[$class->function_strings[54]](234,234) !== array($class->error_msg, "")){
    ...
    if ( $class->function_list[$class->function_strings[54]](234,23) !== array($class->prec(sqrt(pow(234,2)-pow(23,2)),4), "Watts")){
        $test->set_fail($class->function_strings[54]);
        $fail++;
    } else {
        $test->set_pass($class->function_strings[54]);
