...
function Resist_Cap_Ser_test($test, $class){
    $fail = 0;
    $pass = 0;
    if ( $class->function_list[$class->function_strings[1]](234, 234) !== array($class->prec(234/pow(234,2), 4), "Capacitive Reactance")){
    ...
    if ( $class->function_list[$class->function_strings[2]](234, 234) !== array($class->prec(234/234,4), "Capacitive Reactance")){
    ...
    if ( $class->function_list[$class->function_strings[3]](234, 234) !== array($class->prec(pow(234, 2)/234,4), "Capacitive Reactance")){
    ...
    if ( $class->function_list[$class->function_strings[4]](234, 234) !== array($class->prec(1/(2*$class->PI*234*234),4), "Capacitive Reactance")){
    ...
    if ( $class->function_list[$class->function_strings[5]](234, 23) !== array($class->prec(sqrt(pow(234, 2) - pow(23, 2)),4), "Capacitive Reactance")){
        $test->set_fail($class->function_strings[5]);
        $fail++;
    } else {
        $test->set_pass($class->function_strings[5]);
    ...
    if ( $class->function_list[$class->function_strings[6]](234, 234) !== array($class->prec(234/234,4), "Capacitor Amp")){
    ...
    if ( $class->function_list[$class->function_strings[7]](234, 234) !== array($class->prec(sqrt(234/234),4), "Capacitor Amp")){
    ...
    if ( $class->function_list[$class->function_strings[8]](234, 234) !== array($class->prec(234/234,4), "Capacitor Amp")){
    ...
    if ( $class->function_list[$class->function_strings[9]](234, 234) !== array($class->prec(1/(2*$class->PI*234*234),4), "Capacitor Rating")){
    ...
    if ( $class->function_list[$class->function_strings[10]](234, 23) !== array($class->prec(sqrt(pow(234,2) - pow(23,2)),4), "Capacitor VARs")){
        $test->set_fail($class->function_strings[10]);
        $fail++;
    } else {
        $test->set_pass($class->function_strings[10]);
    ...
    if ( $class->function_list[$class->function_strings[11]](234,234) !== array($class->prec(pow(234,2),4) * 234, "Capacitor VARs")){
    ...
    if ( $class->function_list[$class->function_strings[12]](234,234) !== array($class->prec(pow(234,2)/234,4), "Capacitor VARs")){
    ...
    if ( $class->function_list[$class->function_strings[13]](234,234) !== array($class->prec(234*234,4), "Capacitor VARs")){
    ...
    if ( $class->function_list[$class->function_strings[14]](234,234) !== array($class->prec(234*234), "Capacitor Volts")){
    ...
    if ( $class->function_list[$class->function_strings[15]](234,23) !== array($class->prec(sqrt(pow(234,2)-pow(23,2)),4), "Capacitor Volts")){
        $test->set_fail($class->function_strings[15]);
        $fail++;
    } else {
        $test->set_pass($class->function_strings[15]);
    ...
    if ( $class->function_list[$class->function_strings[16]](234,234) !== array($class->prec(sqrt(234*234)), "Capacitor Volts")){
    ...
    if ( $class->function_list[$class->function_strings[17]](234,234) !== array($class->prec(234/234,4), "Capacitor Volt")){
    ...
    if ( $class->function_list[$class->function_strings[18]](234,234) !== array($class->prec(sqrt(pow(234,2)+pow(234,2)),4), "Impedance")){
    ...
    if ( $class->function_list[$class->function_strings[20]](234,234) !== array($class->prec(234/pow(234,2),4), "Impedance")){
    ...
    if ( $class->function_list[$class->function_strings[21]](234,234) !== array($class->prec(234/234,4), "Impedance")){
    ...
    if ( $class->function_list[$class->function_strings[22]](234,234) !== array($class->prec(pow(234,2)/234,4), "Impedance")){
    ...
    if ( $class->function_list[$class->function_strings[23]](234,234) !== array($class->prec(234/234,4), "Power Factor")){
    ...
    if ( $class->function_list[$class->function_strings[26]](234) !== array($class->prec(cos(234),4), "Power Factor")){
    ...
    if ( $class->function_list[$class->function_strings[27]](234,234) !== array($class->prec(234/pow(234,2),4), "Resistance")){
    ...
    if ( $class->function_list[$class->function_strings[28]](234,23) !== array($class->prec(sqrt(pow(234,2)-pow(23,2)),4), "Resistance")){
        $test->set_fail($class->function_strings[28]);
        $fail++;
    } else {
        $test->set_pass($class->function_strings[28]);
    ...
    if ( $class->function_list[$class->function_strings[29]](234,234) !== array($class->prec(pow(234,2)/234,4), "Resistance")){
    ...
    if ( $class->function_list[$class->function_strings[30]](234,234) !== array($class->prec(234*234,4), "Resistance")){
    ...
    if ( $class->function_list[$class->function_strings[33]](234,234) !== array($class->prec(sqrt(234/234),4), "Resistor Amp")){
    ...
    if ( $class->function_list[$class->function_strings[34]](234,23) !== array($class->prec(sqrt(pow(234,2)-pow(23,2)),4), "Resistor Volts")){
        $test->set_fail($class->function_strings[34]);
        $fail++;
    } else {
        $test->set_pass($class->function_strings[34]);
    ...
    if ( $class->function_list[$class->function_strings[35]](234,234) !== array($class->prec(234*234,4), "Resistor Volts")){
    ...
    if ( $class->function_list[$class->function_strings[39]](234,234) !== array($class->prec(234/234,4), "Total Amp")){
    ...
    if ( $class->function_list[$class->function_strings[41]](234,234) !== array($class->prec(sqrt(pow(234,2)*pow(234,2)),4), "Total Volts")){
    ...
    if ( $class->function_list[$class->function_strings[42]](234,234) !== array($class->prec(234*234,4), "Total Volts")){
    ...
    if ( $class->function_list[$class->function_strings[43]](234,234) !== array($class->prec(234/234,4), "Total Volt")){
    ...
    if ( $class->function_list[$class->function_strings[44]](234,234) !== array($class->prec(234/234,4), "Total Volt")){
    ...
    if ( $class->function_list[$class->function_strings[45]](234,234) !== array($class->prec(234*234,4), "Volt Amps")){
    ...
    if ( $class->function_list[$class->function_strings[46]](234,234) !== array($class->prec(pow(234,2)*234,4), "Volt Amps")){
    ...
    if ( $class->function_list[$class->function_strings[48]](234,234) !== array($class->prec(sqrt(pow(234,2)+pow(234,2)),4), "Volt Amps")){
    ...
    if ( $class->function_list[$class->function_strings[49]](234,234) !== array($class->prec(234/234,4), "Volt Amp")){
    ...
    if ( $class->function_list[$class->function_strings[51]](234,23) !== array($class->prec(sqrt(pow(234,2)-pow(23,2)),4), "Watts")){
        $test->set_fail($class->function_strings[51]);
        $fail++;
    } else {
        $test->set_pass($class->function_strings[51]);
